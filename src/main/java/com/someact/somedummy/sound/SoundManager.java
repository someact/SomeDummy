package com.someact.somedummy.sound;
...
/**
 * Customizable sound effects engine for SomeDummy with robust fallback support.
 */
public class SoundManager {
    ...
    public SoundManager(SomeDummyPlugin plugin) {
        this.plugin = plugin;
